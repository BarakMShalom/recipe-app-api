...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 90,
            'price': '9.50',
            'ingredients': [{'name': 'Sugar'}, {'name': 'Butter'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Bread')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Beans')
        r2 = create_recipe(user=self.user, title='Roast')
        in1 = Ingredient.objects.create(user=self.user, name='Cheese')
        in2 = Ingredient.objects.create(user=self.user, name='Chicken')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Meat')
